...
int lsubprocess_create(lsubprocess_t *subprocess, const char *command, bool use_stdin) __THROW
	__nonnull((1, 2));
...
extern size_t lsubprocess_bufferize_stdin(lsubprocess_t *subprocess, const void *buf,
					  size_t count) __THROW __nonnull((1, 2));
